...
def get_args():
    ...
    parser.add_argument('-rp', '--runner_plan', type=str,
...
def get_logger(arguments):
    ...
    logging.info(f"concept: '{arguments.concept}', input: '{arguments.input.name}', output: '{arguments.output}', "
...
if __name__ == "__main__":
    ...
    runner_instance = runner.Runner(logger=logger, concept=args.concept, input=args.input,
                                    output=args.output, verbose=args.verbose, runner_plan=args.runner_plan)
