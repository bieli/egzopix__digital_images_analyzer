...
class Runner:
    ...
    def get_package_instance(self, module_name):
        ...
        self.logger.debug(f'CALL get_package_instance() with '
    ...
    def run(self, last_output_data={}):
        ...
        modules_instances = ((module_name, self.get_package_instance(module_name)) for module_name in splited_runner_plan)
        ...
        for module_name, module_instance in modules_instances:
            ...
            data_tmp = last_output_data[last_module_name] \
                if last_module_name != '' and last_module_name in last_output_data else last_output_data
            last_runnable_instance = module_instance.RunnableBlock(last_runnable_instance=last_runnable_instance,
                                                                   **self.args)
